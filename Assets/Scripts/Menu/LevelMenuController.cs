...
public class LevelMenuController : MonoBehaviour {
    ...
    [SerializeField] int maxMapIndex;
    ...
    private void Start() {
        ...
        // Place the player on the current level
        playerIcon.transform.position = new Vector3(lvlX[index], lvlY[index]);
        targetPos = playerIcon.transform.position;
    ...
    private void FixedUpdate() {
        ...
        //try going to the next level
            ...
            if (index < maxIndex && index < maxMapIndex) {
                index++;
            }
        }
        ...
        if (Input.GetButtonDown("Submit") && pressed == false) {
            ...
            pressed = true;
            // If you go backwards to the previous map, don't update the index
            //// This is so that the player spawns at the place where he came from on the other map
